...
public:
    ...
    float getSample(); //getSample() should return 1 sample of the oscillator and advance the index member variable [9] by indexIncrement member variable [10] which is frequency-dependent. This is the core of the wavetable synthesis algorithm;
